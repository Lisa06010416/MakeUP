...
test_xiaohongshu_url = "https://www.xiaohongshu.com/discovery/item/5fabd8c60000000001005b70?source=question"
...
class TestDcardScraper:
    ...
    def test_scraper(self):
        scraper = DcardScraper.get_scraper(executable_path=chromedriver_path)
        articles = scraper.scraper(keyword="口紅", savepath="testdata/image/")
        assert articles
